...
class AddIngredientButton extends React.Component {
    ...
    render() {
        return (
            <div>
                <Button variant="text" size="large" color="inherit" onClick={this.handleIngredientAddOpen} >
                    Add Ingredient
                </Button>
                <Dialog open={this.state.openAddIngredient} onClose={this.handleIngredientAddClose} aria-labelledby="product-title" >
                    ...
                    <DialogContent>
                        ...
                        <FormControl style={this.state.style}>
                            <TextField label="Ingredient name" name="ingredientTitle" onChange={this.handleNewIngredientChange("ingredientTitle")} />
                        </FormControl>

                        <FormControl style={this.state.style}>
                            <TextField label="Ingredient quantity" name="ingredientQuantity" onChange={this.handleNewIngredientChange("ingredientQuantity")} />
                        </FormControl>
                    ...
                    <DialogActions>
                        <Button size="large" color="primary" target="_blank" onClick={this.saveIngredient} >
                            <SaveIcon /> Add new Ingredient
                      </Button>
                        <IconButton aria-label="close" color="primary" onClick={this.handleIngredientAddClose} >
                            <CloseIcon />
                        </IconButton>
                    </DialogActions>
                </Dialog>
